...
const AppointmentScheduling = () => {
  ...
  const fetchAppointments = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/appointments`, {
        method: 'GET',
        headers: {
  ...
  const fetchDoctors = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_APP_API_URL}/api/doctor-profiles`, {
        method: 'GET',
        headers: {
